...
2. Identify the type of attack and the systems affected
...
3. Protect the assets in your organization from being compromised
...
4. Detect similar incidents in the future
...
5. Respond to future cybersecurity attacks
